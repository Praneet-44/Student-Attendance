...
export function AdminReports() {
  ...
  function exportPDF() {
    ...
    doc.text(`Total Records: ${stats.total} | Present: ${stats.present} | Absent: ${stats.absent} | Rate: ${stats.percentage}%`, 14, 34);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">View and export attendance data</p>
      </div>
